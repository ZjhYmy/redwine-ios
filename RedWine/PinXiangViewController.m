...
@interface PinXiangViewController ()

#define ScreenWidth  [UIScreen mainScreen].bounds.size.width
#define ScreenHeight  [UIScreen mainScreen].bounds.size.height
@end

@implementation PinXiangViewController
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (offX == 0) {
        ...
        self.move.frame = CGRectMake(self.leftBtn.frame.origin.x+10, 43, 70, 1);
        ...
        self.move.frame = CGRectMake(self.middleBtn.frame.origin.x+10, 43, 70, 1);
    ...
    {
        self.move.frame = CGRectMake(self.rightBtn.frame.origin.x+10, 43, 70, 1);
...
- (IBAction)pinXBtn:(UIButton *)sender {
    
    [self.scrollView setContentOffset:CGPointMake((sender.tag - 55) * ScreenWidth, 0) animated:YES];
     self.move.frame = CGRectMake(sender.frame.origin.x+10, 43, 70, 1);
